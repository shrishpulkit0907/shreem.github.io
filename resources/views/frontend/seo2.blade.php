            ...
            <div class="col-lg-6 col-12">
                <div class="row">
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="card p-3" style="border-radius: 10px;">
                            <div class="card-body pb-2">
                                <img width="50" height="50"  src="{{asset('images/stat-3.webp')}}" style="background: var(--color-yellow);padding:10px;border-radius:10px;margin-bottom:10px;"/>
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="card p-3" style="border-radius: 10px;">
                            <div class="card-body pb-2">
                                <img width="50" height="50"  src="{{asset('images/stat-1.webp')}}" style="background: var(--color-yellow);padding:10px;border-radius:10px;margin-bottom:10px;"/>
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="card p-3" style="border-radius: 10px;">
                            <div class="card-body pb-2">
                                <img width="50" height="50"  src="{{asset('images/stat-2.webp')}}" style="background: var(--color-yellow);padding:10px;border-radius:10px;margin-bottom:10px;"/>
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="card p-3" style="border-radius: 10px;">
                            <div class="card-body pb-2">
                                <img width="50" height="50"  src="{{asset('images/stat-4.webp')}}" style="background: var(--color-yellow);padding:10px;border-radius:10px;margin-bottom:10px;"/>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-12 my-3">
                <div class="card p-3" style="border-radius: 10px;">
                    <div class="card-body">
                        <span class="d-inline-block m-auto mb-3" style="background:var(--color-yellow);padding:10px 20px;border-radius:8px;">
...
<section id="s360s">
    <div class="container">
        <div class="col-12 text-center">
            <h3 class="fs36" style="color: var(--color-navy);" >Premium Tools Our Best SEO Company Mastered In</h3>
...
<section id="" class="cta">
    <div class="container">
        <div class="col-lg-12 text-center">
                ...
                <div class="col-12 text-center"><a href="#" class="button11">Get Traffic</a></div>
        </div>
    </div>
</section>
{{-- cta --}}
...
<section id="whychooseus">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-7 col-12">
                <div class="col-12" style="background: var(--color-navy);
            width: 100%;
            height: 100%;
    ...
    font-weight: 800;
    line-height: normal;
    background: linear-gradient(90deg, var(--color-yellow) 6.14%, var(--color-yellow) 83.37%);
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                          <span class="input-group-text" id="basic-addon2">
                            <button class="button11"> Subscribe</button>
                          </span>
                        </div>
                      </div>
                </div>
...
<section id="" class="cta">
    <div class="container">
        <div class="col-lg-12 text-center">
                ...
                <div class="col-12 text-center"><a href="#" class="button11">Connect with Experts</a></div>
        </div>
    </div>
</section>
{{-- cta --}}
    ...
    <div class="container" style="max-width: 1300px;">
        <div class="row">
            <div class="col-lg-6 col-12 my-auto align-self-center">
                <h3 class="fs44" style="color:var(--color-navy)">Let’s Get Started</h3>
            <p class="fs18 ff-poppins " style="color:var(--color-navy)">Drop a message; we'll reach out to explore your digital requirements together. Let's shape your online success collaboratively.</p>
            </div>
            <div class="col-lg-6 col-12">
                <div class="card p-4" style="border-radius: 10px;">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                        <button class="button10 col-lg-4 col-8">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
